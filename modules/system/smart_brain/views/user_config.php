...
?>
    ...
    <!-- Manual Live Blacklist — independent form, structurally outside user-config form -->
    <form method="POST" action="<?= htmlspecialchars($smartBrainUrl) ?>/blacklist/save" id="blacklist-form">
        <div class="row">
            <div class="col-md-12 mb-4">
