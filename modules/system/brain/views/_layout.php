<?php
/**
 * Brain Module - Unified Layout Template
 * 
 * Usage: 
 *   $pageTitle = 'Brain - Page Name';
 *   $activeTab = 'tabname';
 *   $pageContent = function() { ... page content ... };
 *   require local path computations . '/_layout.php';
 * 
 * Or use the helper function brainLayout()
 */
...
<?php /* RULES
 * Layout must include tabs via SystemPaths / PackMap ONLY (no local path computations)
 */ ?>
