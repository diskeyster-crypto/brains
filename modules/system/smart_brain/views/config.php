            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <?php
                        ...
                        $allPatterns = ['double_bottom' => 'Double Bottom', 'double_top' => 'Double Top', 'pullback_trend_continue' => 'Pullback Trend Continue', 'double_bottom_confirm_v2' => 'Double Bottom V2', 'double_top_confirm_v2' => 'Double Top V2', 'double_bottom_contextual_v2' => 'Double Bottom Contextual V2', 'double_bottom_contextual_v3' => 'Double Bottom Contextual V3'];
                    ?>
