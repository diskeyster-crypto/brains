        ...
        try {
            ...
            foreach ($intents as $intent) {
                ...
                $normalized = [
                    ...
                    'created_at' => $intent['created_at'] ?? ($intent['created_ts'] ? date('c', (int)$intent['created_ts']) : date('c')),
                    'expires_at' => $intent['expires_at'] ?? 0,
                    'risk' => $risk,
                    'trailing' => $brainTrailing,
                    'brain' => [],
                    'source' => 'brain_live_intent',
                    'intent_created_at' => $intent['created_at'] ?? ($intent['created_ts'] ? date('c', (int)$intent['created_ts']) : date('c')),
                    'brain_controlled' => true,
