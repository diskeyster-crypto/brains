  ...
  <form method="post" action="<?= $e($ajaxUrl) ?>">
    ...
    <div class="cfg-section">
      ...
      <div class="cfg-grid">
        ...
        <div><label class="cfg-label">recovery_min_duration_minutes</label><input type="number" name="recovery_min_duration_minutes" min="30" max="360" value="<?= $e((int)$cfg('recovery_min_duration_minutes', 120)) ?>" class="form-control" style="height:30px;font-size:13px;padding:2px 8px;"></div>
        ...
        <div><label class="cfg-label">fast_spike_diagnostic_enabled</label><select name="fast_spike_diagnostic_enabled" class="form-control" style="height:30px;font-size:13px;padding:2px 8px;"><option value="1" <?= (bool)$cfg('fast_spike_diagnostic_enabled', true) ? 'selected' : '' ?>>true</option><option value="0" <?= !(bool)$cfg('fast_spike_diagnostic_enabled', true) ? 'selected' : '' ?>>false</option></select></div>
        <div><label class="cfg-label">fast_spike_window_minutes</label><input type="number" name="fast_spike_window_minutes" min="1" max="60" value="<?= $e((int)$cfg('fast_spike_window_minutes', 10)) ?>" class="form-control" style="height:30px;font-size:13px;padding:2px 8px;"></div>
        <div><label class="cfg-label">fast_spike_price_change_pct</label><input type="number" name="fast_spike_price_change_pct" step="0.01" min="0" max="100" value="<?= $e((float)$cfg('fast_spike_price_change_pct', 2.0)) ?>" class="form-control" style="height:30px;font-size:13px;padding:2px 8px;"></div>
        <div><label class="cfg-label">fast_spike_roi_equivalent_leverage</label><input type="number" name="fast_spike_roi_equivalent_leverage" step="0.1" min="1" max="200" value="<?= $e((float)$cfg('fast_spike_roi_equivalent_leverage', 5)) ?>" class="form-control" style="height:30px;font-size:13px;padding:2px 8px;"></div>
        <div><label class="cfg-label">fast_spike_roi_equivalent_threshold</label><input type="number" name="fast_spike_roi_equivalent_threshold" step="0.01" min="0" max="1000" value="<?= $e((float)$cfg('fast_spike_roi_equivalent_threshold', 10.0)) ?>" class="form-control" style="height:30px;font-size:13px;padding:2px 8px;"></div>
      </div>
    </div>
