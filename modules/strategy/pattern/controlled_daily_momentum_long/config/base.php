...
return [
    ...
    // ── Soft turnover ramp ────────────────────────────────────────────────────
    'min_turnover_1h_vs_avg_24h'       => 1.3,  // min 1h/avg24h turnover ratio (turnover_too_low)
    'max_turnover_1h_vs_avg_24h'       => 4.0,  // max 1h/avg24h ratio (turnover_spike_too_large)
    'min_turnover_ramp_15m_ratio'      => 1.15, // min 15m ramp ratio
    'volume_persistence_window'        => 4,    // bars to check for volume persistence
    'min_volume_persistence_candles'   => 3,    // min bars with above-average volume
    'max_volume_cliff_ratio'           => 0.45, // volume_cliff_after_pump if last bar < this * peak
