...
?>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body p-0">
            <table class="table table-dark table-hover mb-0">
                <thead><tr><th>Symbol</th><th>Entry Price</th><th>Current Price</th><th>ROI</th><th>MAE</th><th>MFE</th><th>Exit Mode</th><th>Stop Mode</th><th>Trailing</th><th>BE</th><th>Leverage</th><th>Opened</th></tr></thead>
                <tbody>
                    <?php if (empty($active)): ?>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body p-0">
            <table class="table table-dark table-hover mb-0">
                <thead><tr><th>Symbol</th><th>Entry</th><th>Exit</th><th>ROI</th><th>MAE</th><th>MFE</th><th>Exit Mode</th><th>Stop Mode</th><th>Reason</th><th>Duration</th></tr></thead>
                <tbody>
                    <?php if (empty($closed)): ?>
                        <tr><td colspan="10" class="text-center text-secondary py-4">No closed positions</td></tr>
                    <?php else: ?>
