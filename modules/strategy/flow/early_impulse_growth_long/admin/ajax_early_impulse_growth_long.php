...
if ($action === 'save_config') {
    ...
    $overrides = array_merge($existing, [
        ...
        'recovery_structure_enabled' => $boolField('recovery_structure_enabled', true),
        'recovery_min_candles_after_low' => $intField('recovery_min_candles_after_low', 3, 200, 20),
        'recovery_min_higher_lows' => $intField('recovery_min_higher_lows', 1, 100, 5),
        'recovery_min_higher_closes' => $intField('recovery_min_higher_closes', 1, 100, 5),
        'recovery_max_single_candle_dominance_pct' => $floatField('recovery_max_single_candle_dominance_pct', 10.0, 100.0, 60.0),
        'recovery_max_speed_pct_per_min' => $floatField('recovery_max_speed_pct_per_min', 0.01, 10.0, 0.3),
        'recovery_min_structure_score' => $floatField('recovery_min_structure_score', 0.0, 1.0, 0.55),
        ...
        'coin_context_enabled' => $boolField('coin_context_enabled', true),
